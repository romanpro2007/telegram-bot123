...
# Данные
cities = {
    "Николаев": ["Центральный", "Ингульский", "Соляные", "Лески", "Намыв", "Корабельный", "Заводской", "Северный"],
    "Вознесенск": ["Доманевка", "Александровка", "Вознесенск", "Прибужье", "Прибужаны", "Южноукраинск", "Первомайск"],
    ...
    "Баштанка": ["Баштанка", "Доброе", "Новоегоровка", "Явкино"]
